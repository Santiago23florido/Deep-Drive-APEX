...
Le dossier \path{full_soft/} est organise en plusieurs sous-ensembles:
...
Cette coexistence est un fait confirme par le depot. Elle indique une transition entre une version initiale et une version refactorisee, mais aucun fichier ne designe explicitement l'un des deux comme unique point d'entree officiel.
