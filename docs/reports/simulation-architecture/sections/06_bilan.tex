...
La coexistence de plusieurs simulations historiques peut aussi creer de la confusion: Gazebo Sim APEX, ancien \path{spawn_rc_car.launch.py}, simulation \path{voiture_system} avec Gazebo Classic, et ancienne reference externe de simulateur Python issue de \path{full_soft/Simulateur}, qui n'est plus versionnee dans \path{main}.
