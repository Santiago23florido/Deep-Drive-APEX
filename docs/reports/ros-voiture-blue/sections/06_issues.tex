...
\begin{itemize}
  \item Plusieurs architectures coexistent ou sont documentees: APEX, \path{voiture_system}, anciens chemins de simulation et ancienne reference Python externe. Cette coexistence documentaire peut compliquer l'onboarding.
