...
class SlamMapRecorderNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("map_topics", ["/map", "/apex/slam/noisy/map"])
        self.declare_parameter("map_frames", ["map", "noisy/map"])
        self.declare_parameter("base_frames", ["base_link", "noisy/base_link"])
