...
cat > "${HOST_RUN_DIR}/capture_meta.json" <<EOF
{
  ...
  "bridge_launch_boost_speed_pct": ${BRIDGE_LAUNCH_BOOST_SPEED_PCT},
  "bridge_launch_boost_hold_s": ${BRIDGE_LAUNCH_BOOST_HOLD_S}
}
EOF
...
APEX_BRIDGE_LAUNCH_BOOST_HOLD_S="${BRIDGE_LAUNCH_BOOST_HOLD_S}" \
