...
def compute_speed(convoluted_lidar, target_angle: float):
    #TODO: rewrite this to get from global constants, and describe when to use, straight, curve, stop, etc.
    ...
    #TODO: Modify speed to simplify the function - depending on angle only
