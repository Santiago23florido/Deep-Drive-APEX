'''
Docstring for code.algorithm.constants


this module will be DEPRECATED -> ConfigLoader should be used.
...
def load_constants(new_filepath="config.json"):
    ...
    global MINIMUM_FRONT_DISTANCE_LIDAR
    
    
    MINIMUM_FRONT_DISTANCE_LIDAR = 0.15 
