...
import Lidar.logger.voiture_logger as cl
from Lidar.logger.constants import LIDAR_BAUDRATE, LIDAR_HEADING_OFFSET_DEG, LIDAR_FOV_FILTER, LIDAR_POINT_TIMEOUT_MS
...
class RPLidarReader(LiDarInterface):
    ...
    # TODO: Add it to VisualizationManager and make it work with the shared memory data
