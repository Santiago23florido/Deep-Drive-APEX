...
def load_constants(new_filepath="config.json"):
    ...
    global TRACK_DIRECTION #Important parameter, modify to change what the car considers the correct direction, default red left green right
    ...
    TRACK_DIRECTION = int(get_config_value(cfg, "TRACK_DIRECTION", 0)) #remplacer le 0 pour changer le sens de la piste
    ...
    LIDAR_HEADING_OFFSET_DEG = int(get_config_value(cfg, "LIDAR_HEADING_OFFSET_DEG", -70))
    LIDAR_POINT_TIMEOUT_MS = int(get_config_value(cfg, "LIDAR_POINT_TIMEOUT_MS", 10))
    ...
    CONVOLUTION_SIZE = int(get_config_value(cfg, "CONVOLUTION_SIZE", 2))
    ...
    STEER_CENTER = 0.5 * (DC_STEER_MAX + DC_STEER_MIN) - 0.33
